        ...
        <nav id="navbar" class="navbar">
            <ul>
                ...
                <form id="logoutForm" method="POST" action="/logout">
                    ...
                    <input style="background: white;border: white solid 1px; color: #0a53be; margin-left: 30px; margin-bottom: -14px" type="submit" value="Logout" />
                </form>
            </ul>
...
<table class="table" style="margin-top: 10px">
    ...
    <c:forEach var="users" items="${allUsers}">
        <tr>
            <td><a href="/users/${users.id}/edit">${users.username}</a></td>
            <td>${users.roles}</td>
        </tr>
    </c:forEach>
    </tbody>
