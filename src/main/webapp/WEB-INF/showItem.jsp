...
<button style="margin-top: 10px" type="submit" class="btn btn-warning" type="submit"><a href="/items">Back To Items</a></button>
<form action="/items/${item.id}/delete" method="get">
    <input type="hidden" name="_method" value="delete">
    <button style="margin-top: 10px" type="submit" class="btn btn-outline-danger" type="submit">Delete Item</button>
</form>
<button style="margin-top: 10px" type="submit" class="btn btn-dark"><a href ='/items/${item.id}/edit'>Edit</a></button>
</div>
</body>
</html>