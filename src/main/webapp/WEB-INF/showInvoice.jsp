...
<h3>Total Price: ${invoice.invoiceTotal} $</h3>
<button style="margin-top: 10px" type="submit" class="btn btn-warning" type="submit"><a href="/invoices">Back To Invoices</a></button>
<%--<form action="/items/${invoice.id}/delete" method="get">--%>
